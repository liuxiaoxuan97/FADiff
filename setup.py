...
setup(
  ...
  url = 'https://github.com/liuxiaoxuan97/cs107-FinalProject',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/liuxiaoxuan97/cs107-FinalProject/archive/v_03.tar.gz',    # I explain this later on
